...
sf::Vector2f Peg::getInputPoint() {
    return sf::Vector2f((float) (position & 0b1111u) * 11 + 5.5f, (float) ((position & 0b11110000u) >> 4u) * 11 + 5.5f);
}

sf::IntRect Peg::getBodyRectangle(sf::Vector2u componentPosition) {
    return sf::IntRect(componentPosition.x + 2, componentPosition.y + 2, 9, 9);
}

sf::IntRect Peg::getInputRectangle(sf::Vector2u componentPosition) {
    return sf::IntRect(componentPosition.x + 4, componentPosition.y + 4, 3, 3);
}

sf::IntRect Peg::getOutputRectangle(sf::Vector2u componentPosition) {
    return sf::IntRect();
}

void Peg::drawWires(sf::RenderWindow& window, sf::Vector2u fragmentPosition) {
    calculateInput();
    BasicComponent::drawWires(window, fragmentPosition);
}
